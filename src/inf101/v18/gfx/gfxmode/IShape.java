...
public interface IShape {
   ...
   *
   * <p> For use with {@link #arc()}
   *
   * @param a The angle, in degrees
   * @return <code>this</code>, for adding more drawing parameters or issuing the draw command
   */
   ...
   *
   * <p> Relevant parameters: <li>{@link #at(Point)}, {@link #x(double)}, {@link #gravity(double)}
   * <li>{@link #length(double)} <li>{@link #angle(double)} <li>{@link #gravity(Gravity)} <li>{@link
   * #stroke(Paint)}, {@link #fill(Paint)} <li>{@link #rotation(double)}
   *
   * @return <code>this</code>, for adding more drawing parameters or issuing the draw command
   */
  IShape arc();
   ...
   *
   * <p> Relevant parameters: <li>{@link #at(Point)}, {@link #x(double)}, {@link #gravity(double)}
   * <li>{@link #width(double)}, {@link #height(double)} <li>{@link #gravity(Gravity)} <li>{@link
   * #stroke(Paint)}, {@link #fill(Paint)} <li>{@link #rotation(double)}
   *
   * @return <code>this</code>, for adding more drawing parameters or issuing the draw command
   */
   ...
   *
   * Gravity determines the point on the shape that will be used for positioning and rotation.
   *
   * @param g The gravity
   */
   ...
   *
   * <p> For use with {@link #line()} and {@link #arc()}
   *
   * @param l The length
   * @return <code>this</code>, for adding more drawing parameters or issuing the draw command
   */
   ...
   *
   * <p> Relevant parameters: <li>{@link #at(Point)}, {@link #x(double)}, {@link #gravity(double)}
   * <li>{@link #length(double)} <li>{@link #angle(double)} <li>{@link #gravity(Gravity)} (flattened
   * to the horizontal axis, so, e.g., {@link Gravity#NORTH} = {@link Gravity#SOUTH} = {@link
   * Gravity#CENTER}) <li>{@link #stroke(Paint)} <li>{@link #rotation(double)}
   *
   * @return <code>this</code>, for adding more drawing parameters or issuing the draw command
   */
  IShape line();
   ...
   *
   * <p> Shapes will be rotate around the {@link #gravity(Gravity)} point.
   *
