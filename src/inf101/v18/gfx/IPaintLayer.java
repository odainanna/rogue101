...
public interface IPaintLayer {
   ...
   * Clear the layer.
   *
   * <p> Everything on the layer is removed, leaving only transparency.
   */
  void clear();
   ...
   *
   * <p> There will still be background behind this layer. You may clear it or draw to it using
   * {@link Screen#clearBackground()}, {@link Screen#setBackground(javafx.scene.paint.Color)} and
