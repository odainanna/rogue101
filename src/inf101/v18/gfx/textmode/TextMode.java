...
public enum TextMode {
   ...
   *
   * For "high" resolution, characters will be squeezed horizontally to fit half the width.
   */
   ...
   *
   * @return One of {@link Screen#ASPECT_WIDE}, {@link Screen#ASPECT_MEDIUM} or {@link
   * Screen#ASPECT_CLASSIC}
   */
  ...
  protected static class Constants {
    ...
    protected static TextMode getMode(int i) {
      if (MODES == null) {
        MODES = new TextMode[]{MODE_40X22, MODE_40X25, MODE_40X30, MODE_80X22, MODE_80X25,
            MODE_80X30};
      }
