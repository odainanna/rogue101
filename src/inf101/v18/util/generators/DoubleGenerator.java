...
public class DoubleGenerator extends AbstractGenerator<Double> {
  ...
  /**
   * Make a generator for positive doubles from 0 (inclusive) to maxValue (exclusive).
   *
   ...
   *
   * Due to the way the numbers are constructed, the range from minValue to maxValue can only span
   * half the total range of available double values. If the range is too large the bounds will be
   * divided by two (you can check whether they range is too large by checking
