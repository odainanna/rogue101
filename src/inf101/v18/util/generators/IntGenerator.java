...
public class IntGenerator extends AbstractGenerator<Integer> {
  ...
  /**
   * Make a generator for positive numbers from 0 (inclusive) to maxValue (exclusive).
   *
   ...
   * @return A uniformly distributed random integer in the range 0 (inclusive) to n (exclusive)
