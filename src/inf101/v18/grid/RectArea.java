...
public class RectArea implements IArea {
  ...
  public boolean contains(IPosition pos) {
    return (pos instanceof ILocation && ((ILocation) pos).getArea() == this) || contains(pos.getX(),
        pos.getY());
  }
  ...
  public String toString() {
    String builder = "RectArea [width=" + width + ", height=" + height
        + ", hWrap="
        + hWrap + ", vWrap=" + vWrap + "]";
    return builder;
  }
  ...
  class Location implements ILocation {
    ...
    /**
     * Main constructor. Initializes a new {@link #Location} objects with the corresponding values
     * of x and y.
     *
     * @param x X coordinate
     * @param y Y coordinate
     * @param idx 1-dimensional index
     * @param edgeMask mask with bits {@link RectArea#N}, {@link RectArea#S}, {@link RectArea#E},
     * {@link RectArea#W} set if we're on the corresponding edge of the area
     */
